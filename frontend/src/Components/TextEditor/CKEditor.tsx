 ...
 * https://ckeditor.com/ckeditor-5/builder/#installation/NoZgNARATAdCcUgNgIwAYAcB2DaQFYAWFDJDKFATmKKikKiUqyjTzxBSkQgFMA7RFDDAUYNGDFiJKALqQAJgCMMAQ3JoIsoA
 * 
 * Also EditorConfig is one of the ways to find the text for the editor. (To send it to the backend)
 */
